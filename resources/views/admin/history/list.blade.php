...
<body class="layui-view-body">
        ...
        <div class="layui-row">
            <div class="layui-card">
                <div class="layui-card-body">
                    <div class="form-box">
                        <a href="{{url('admin/history/add')}}" class="layui-btn layui-btn-blue"><i class="layui-icon">&#xe654;</i>新增</a>
                        <table id="demo"></table>
                    </div>
                </div>
            </div>
  ...
  table.render({
    elem: '#demo'
    ,cols: [[ //标题栏
      {field: 'historyid', title: 'ID', width: 120, sort: true}
      ,{field: 'user_id', title: '所属账户', width: 200}
      ,{field: 'content', title: '内容', width: 580}
      ,{field: 'create_time', title: '修改时间', width: 350}
      ,{field: 'operation', title: '操作', width: 350, sort: true}
    ]]
    ,data: <?php echo $data; ?>
    ,skin: 'line' //表格风格
    ,even: true
