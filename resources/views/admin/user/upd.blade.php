                ...
                <form class="layui-form layui-card-body" action="javascript:">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="username" value="{{$data['username']}}" required  lay-verify="required" placeholder="请输入手机号" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="nickname" value="{{$data['nickname']}}" required  lay-verify="required" placeholder="请输入网名" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="password" value="{{$data['password']}}" name="password" required  lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                    <div class="layui-input-block" id='logn-img'>
                        <img  height="150" name='logo'  width="150" src="{{$data['headurl']}}"> 
                    </div>
                  </div>
                  <div class="layui-form-item">
                    <div class="layui-input-block">
