                ...
                <form class="layui-form layui-card-body" action="javascript:">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="title" value="<?php echo $data['title']; ?>" required  lay-verify="required" placeholder="请输入文章标题" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="radio" name="original" value="1" title="原创" <?php if($data['original'] == 1) echo 'checked'; ?> >
                      <input type="radio" name="original" value="0" title="转载" <?php if($data['original'] == 0) echo 'checked'; ?>>
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="radio" name="recommend" value="1" title="推荐" <?php if($data['recommend'] == 1) echo 'checked'; ?> >
                      <input type="radio" name="recommend" value="0" title="不推荐" <?php if($data['recommend'] == 0) echo 'checked'; ?>>
                    </div>
                  </div>
                    ...
                    <div class="layui-input-block">
                      <select name="label_id" lay-verify="required">
                        ...
                        <?php foreach($label as $v): ?>
                          <option <?php if($data['label_id'] == $v['label_id']) echo 'selected = "selected"'; ?> value="{{$v['label_id']}}">{{$v['label_name']}}</option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="layui-input-block">
                      <select name="category_id" lay-verify="required">
                        ...
                        <?php foreach($category as $v): ?>
                          <option <?php if($data['category_id'] == $v['category_id']) echo 'selected = "selected"'; ?> value="{{$v['category_id']}}">{{$v['category']}}</option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="layui-input-block">
                      <select name="author" lay-verify="required">
                        ...
                        <?php foreach($author as $v): ?>
                          <option <?php if($data['author'] == $v['name']) echo 'selected = "selected"'; ?> value="{{$v['name']}}">{{$v['name']}}</option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
