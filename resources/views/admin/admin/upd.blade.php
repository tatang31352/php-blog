    ...
    <div class="layui-content">
        <div class="layui-row">
            <div class="layui-card">
                ...
                <input type="hidden" id="id" required value="<?php echo $data['userid']; ?>">
                  <div class="layui-form-item">
                    <label class="layui-form-label">账户昵称</label>
                    <div class="layui-input-block">
                    <input type="text" name="username" required value="<?php echo $data['username']; ?>" lay-verify="required" placeholder="请输入昵称" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  <div class="layui-form-item">
                    <label class="layui-form-label">密码</label>
                    <div class="layui-input-inline">
                      <input type="password" name="password" value="<?php echo $data['password']; ?>" required lay-verify="required" placeholder="请输入密码" autocomplete="true" class="layui-input">
                    </div>
                    ...
                    <div class="layui-input-block">
                      <select name="home" lay-verify="required">
                        ...
                        <?php foreach($homePage as $v): ?>
                          <option <?php if($data['home_id'] == $v['id']) echo 'selected = "selected"'; ?> value="{{$v['id']}}">{{$v['home_name']}}</option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="layui-input-block">
                      <select name="blog" lay-verify="required">
                        ...
                        <?php foreach($blog as $v): ?>
                          <option <?php if($data['blog_id'] == $v['id']) echo 'selected = "selected"'; ?> value="{{$v['id']}}">{{$v['title']}}</option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="layui-input-block">
                      <select name="author" lay-verify="required">
                       ...
                       <?php foreach($author as $v): ?>
                          <option <?php if($data['author_id'] == $v['id']) echo 'selected = "selected"'; ?> value="{{$v['id']}}">{{$v['name']}}</option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="radio" name="sex" value="1" title="男" <?php if($data['sex'] ==1) echo 'checked'; ?> >
                      <input type="radio" name="sex" value="0" title="女" <?php if($data['sex'] ==0) echo 'checked'; ?>>
                    </div>
                  </div>
                   ...
                   <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="radio" name="programmer" value="1" title="是"  <?php if($data['programmer'] ==1) echo 'checked'; ?> >
                      <input type="radio" name="programmer" value="0" title="否" <?php if($data['programmer'] ==0) echo 'checked'; ?> >
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                      <textarea name="desc" placeholder="请输入内容" class="layui-textarea"><?php echo $data['Remarks']; ?></textarea>
                    </div>
                  </div>
                  <div class="layui-form-item">
                    <div class="layui-input-block">
