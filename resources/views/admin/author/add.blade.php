            ...
            <div class="layui-card">
                ...
                <form class="layui-form layui-card-body" action="javascript:">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="author_name" required  lay-verify="required" placeholder="请输入模板名称" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="name" required  lay-verify="required" placeholder="请输入作者姓名" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                    <!-- logo图回显 -->
                  <div class="layui-form-item">
               ...
               <!--    <div class="layui-form-item">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="introduce" required  lay-verify="required" placeholder="请输入作者简介" autocomplete="off" class="layui-input">
                    </div>
                  </div>  
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="phone" required  lay-verify="required" placeholder="请输入QQ" autocomplete="off" class="layui-input">
                    </div>
                  </div>  
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="gitee" required  lay-verify="required" placeholder="请输入gitLab地址" autocomplete="off" class="layui-input">
                    </div>
                  </div>
...
<!-- 
                  ...
                  <div class="layui-form-item">
                    <div class="layui-input-block">
                      ...
                      <a type="reset" href="{{url('admin/blog/list')}}" class="layui-btn layui-btn-primary">返回</a>
                    </div>
                  </div>
                </form>  
