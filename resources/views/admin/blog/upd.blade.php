    ...
    <div class="layui-content">
        <div class="layui-row">
            <div class="layui-card">
                <div class="layui-card-header">关于博客</div>
                <form class="layui-form layui-card-body" action="javascript:">
                  <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                  <div class="layui-form-item">
                    <label class="layui-form-label">模板名称</label>
                    <div class="layui-input-block">
                      <input type="text" name="blog_name" value="<?php echo $data['blog_name']; ?>" required  lay-verify="required" placeholder="请输入模板名称" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="title"  value="<?php echo $data['title']; ?>"  required  lay-verify="required" placeholder="请输入博客标题" autocomplete="off" class="layui-input">
                    </div>
                  </div>
...
<script type="text/javascript">
    ...
    $('#btn').on('click',function(){
       ...
       var id= $("[name='id']").val();
       var blog_name = $("[name='blog_name']").val();
       var title = $("[name='title']").val();
       var content = UE.getEditor('editor').getContent();
       if(title == '' || content == '' || blog_name == ''){
            return;
       } 
    
       $.ajax({
           type:"post",
           url:"{{url('admin/blog/upd')}}",
           data:{
                id:id,
                _token:token,
                blog_name:blog_name,
