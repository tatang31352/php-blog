                ...
                <form class="layui-form layui-card-body" action="javascript:">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="category" required  lay-verify="required" placeholder="请输入昵称" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="radio" name="sex" value="1" title="生活" checked>
                      <input type="radio" name="sex" value="0" title="编程">
                    </div>
                  </div>
